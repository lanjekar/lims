...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mobile' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'user_role' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'Admin', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'lab_id_user_fk' => ['type' => 'index', 'columns' => ['lab_id'], 'length' => []],
            'state_id_user_fk' => ['type' => 'index', 'columns' => ['state_id'], 'length' => []],
            'district_id_user_fk' => ['type' => 'index', 'columns' => ['district_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id'], 'length' => []],
            'district_id_user_fk' => ['type' => 'foreign', 'columns' => ['district_id'], 'references' => ['district_masters', 'district_id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
            'lab_id_user_fk' => ['type' => 'foreign', 'columns' => ['lab_id'], 'references' => ['lab_masters', 'lab_id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
            'state_id_user_fk' => ['type' => 'foreign', 'columns' => ['state_id'], 'references' => ['state_masters', 'state_id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created_by' => 1,
            'created_on' => '2018-03-10 12:15:12',
            'modified_by' => 1,
            'modified_on' => '2018-03-10 12:15:12'
        ],
    ];
}
